...
export function HeroGiftCard() {
    return (
        <div className="flex flex-col">
            <div className="h-[500px] w-[400px] bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border border-blue-200 p-8 z-20">
        ...
        <img src={robotHand} className="hidden sm:block h-[360px] absolute top-[292px] right-0" alt="" />
        </div>
    )
}